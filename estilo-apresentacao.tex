...
\def\lecturename{Qualificação de Mestrado}
...
\begin{tiny}
 ...
 PPGI - Programa de P\'{o}s-Gradua\c{c}\~{a}o em Inform\'{a}tica \\
 Universidade Federal do Amazonas (UFAM) \\
 Email: aac@icomp.ufam.edu.br \\
\end{tiny}
}
...
\setbeamertemplate{title page}
{
  ...
  \fi%     
  \vskip1em\par
  \emph{\lecturename}\par \insertdate\par
  \vskip0pt plus1filll
